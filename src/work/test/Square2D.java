...
public final class Square2D {
    ...
    public Triangle2D[] setDomain() {
        ...
        Point2D[] pts = new Point2D[]{new Point2D(0, 0), new Point2D(1, 0),
            new Point2D(1, 1)};

        // Definition of the points of the second Triangle
        Point2D[] pts1 = new Point2D[]{new Point2D(0, 0), new Point2D(0, 1),
            new Point2D(1, 1)};

        // Definition of the square region
        Region2D r1 = new Region2D(1.0e-3, 0);
    ...
    public Edge[] setEdges(){
        ...
        Point2D[] ptsE0 = new Point2D[]{new Point2D(1, 1), new Point2D(1, 0)};

        // Defining the of the points of the second edge border
        Point2D[] ptsE1 = new Point2D[]{new Point2D(0, 0), new Point2D(0, 1)};

        borderOutput = new Region1D(20.0);
        borderInput = new Region1D(10.0);
